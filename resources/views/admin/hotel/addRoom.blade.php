                    ...
                    <div class="form-group row">
                        <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control" id="inputAddressLine1"
                                placeholder="Room Description(1)" name="room_description1">
                        </div>
                        <div class="col-sm-6">
                            <label for="inputAddressLine2">Room Description(2)</label>
                            <input type="text" class="form-control" id="inputAddressLine2"
                                placeholder="Room Description(2)" name="room_description2">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-6">
                            <label for="inputCity">Room Description(3)</label>
                            <input type="text" class="form-control" id="inputCity" placeholder="Room Description(3)"
                                name="room_description3">
                        </div>
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-3">
                            <label for="inputPostalCode">Available Rooms</label>
                            <div>
                                <input type="number" class="form-control" id="inputPostalCode"
                                    placeholder="Room Quantity" name="room_qty">
                            </div>
                        </div>
                        <div class="col-sm-3">
                            ...
                            <div>
                                <input type="number" class="form-control" id="inputPostalCode"
                                    placeholder="Current Room Price" name="today_price">
                            </div>
